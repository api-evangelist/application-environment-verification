# Application Environment Verification (application-environment-verification)
...
## API
- **Application Environment Verification** — [Documentation](https://github.com/fingerprintjs/aev)
